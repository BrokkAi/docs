# Getting Started with Brokk Desktop

Brokk Desktop is the most powerful way to use Brokk, and the best way to experience all of Brokk's features. It is available for Linux, Windows and Mac Operating Systems. For the optimal experience, we recommend installing Brokk Desktop and at least one of the other interfaces (VS Code or CLI) to get the best of both worlds: the advanced tooling available in Brokk Desktop, and the seamless integration of Brokk into your existing workflow with VS Code or CLI.

[**Download and run the desktop installer**](https://brokk.ai/dashboard?ref=blog.brokk.ai). Linux, Windows and Mac Operating Systems are supported.
...
![](images/quick-start-image-2.png)
...
![](images/quick-start-hello-brokk-3.png)
...
![](images/quick-start-hello-brokk-4.png)
...
![](images/quick-start-hello-brokk-5.png)
