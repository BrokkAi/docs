...
![](images/issue-tracker-integration-c9d04e86-9f42-49e8-a20a-22afea53500cpng.png)
...
2. Choose a different source:
    ...
    - **Jira Connection**: Switch the provider to _Jira_, supply your **Base URL**, **API Token**, and **Project Key**, then test and apply.  
        ![](images/issue-tracker-integration-3-issue-realpng.png)
...
![](images/issue-tracker-integration-5-issuepng.png)
